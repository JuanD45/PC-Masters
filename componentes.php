...
<nav>
    ...
    <a href="computadores.php" class="active">Computadores</a>
...
<main>
    <section class="section">
        ...
        <div class="catalog">
            <?php
            // Consulta los productos que pertenecen a la categoría de computadores (categoria = 2)
            $query = "SELECT * FROM productos WHERE idcategoria = 2";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<p>No hay computadores disponibles.</p>';
            }
            ?>
        </div>
    </section>
